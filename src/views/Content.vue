<template>
  <ion-page>
    ...
    <ion-content class="ion-padding" ref="content" :fullscreen="true"  :scroll-events="true"
    ...
    >
        ...
        <div class="wrapper">
          <ion-toolbar class="ion-margin-vertical ion-padding ion-text-start">
            <b>#Referenced page</b>
            <br/><br/>
            <a href="https://ionicframework.com/docs/api/content" target="_blank">https://ionicframework.com/docs/api/content</a>
          </ion-toolbar>
        </div>
      ...
      <div id="container">
        ...
        <div class="wrapper">
          ...
          <ion-button expand="block" @click="scrollToBottomAction()">Scroll to Bottom</ion-button>
          ...
          <ion-button expand="block" @click="scrollToTopAction()">Scroll to Top</ion-button>
